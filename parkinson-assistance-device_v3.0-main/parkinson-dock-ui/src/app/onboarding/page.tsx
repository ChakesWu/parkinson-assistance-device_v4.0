    ...
    <form onSubmit={onNext} className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">
          This helps personalise your experience. Your data stays on this device.
        </p>
      </div>
      ...
      <div className="space-y-4">
        <Field label="Name *">
          <input
            ...
            className="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-neutral-700 bg-white dark:bg-neutral-800 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
          />
        </Field>
        ...
        <Field label="Sex *">
          <select
            ...
            className="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-neutral-700 bg-white dark:bg-neutral-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
          >
        ...
        <Field label="Race (optional)">
          <input
            type="text"
            placeholder="e.g. Asian, White, Black, etc."
            value={profile.race ?? ''}
