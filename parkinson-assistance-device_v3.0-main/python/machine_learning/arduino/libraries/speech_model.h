// 自动生成的语音帕金森分类模型
// 生成时间: 2025-08-09 23:26:48.187693
// 模型类型: 轻量级线性分类器
// 输入: 8维语音特征
// 输出: 帕金森概率 (0-1)
...
const float SPEECH_WEIGHTS[SPEECH_FEATURE_DIM] = {
    -0.154552f,     0.521490f,     0.407105f,     0.559240f,     -0.295731f,     0.063151f,     -0.084892f,     -0.088574f
};

// 模型偏置
const float SPEECH_BIAS = -0.020361f;

// 特征标准化参数
const float SPEECH_SCALER_MEAN[SPEECH_FEATURE_DIM] = {
    169.206879f,     27.391367f,     0.009780f,     0.053514f,     11.690589f,     0.177600f,     -0.068965f,     0.048057f
};

const float SPEECH_SCALER_STD[SPEECH_FEATURE_DIM] = {
    32.249565f,     10.856379f,     0.007649f,     0.033245f,     4.917834f,     0.951189f,     0.694944f,     0.500191f
};
